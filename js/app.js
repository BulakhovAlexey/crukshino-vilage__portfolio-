    ...
    (() => {
        ...
        let formValidate = {
            ...
            phoneTest(formRequiredItem) {
                return !/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/.test(formRequiredItem.value);
            }
        };
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                setTimeout((() => {
                    if (form.hasAttribute("data-redirect")) window.location = window.location + form.dataset.redirect;
                }), 500);
                formValidate.formClean(form);
        ...
        if (inputTel.length) modules_flsModules.inputmask = Inputmask("+7(999)999-99-99").mask(inputTel);
        ...
        function initSliders() {
            if (document.querySelector(".sliderblock__territory")) new core(".sliderblock__territory", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-controls__button-prev.territory",
                    nextEl: ".slider-controls__button-next.territory"
                }
            });
            if (document.querySelector(".sliderblock__transport")) new core(".sliderblock__transport", {
                modules: [ Navigation, EffectFade ],
                effect: "fade",
                fadeEffect: {
                    crossFade: true
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-controls__button-prev.transport",
                    nextEl: ".slider-controls__button-next.transport"
                }
            });
            if (document.querySelector(".slider-tokio__slider")) new core(".slider-tokio__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-controls__button-prev.tokio",
                    nextEl: ".slider-controls__button-next.tokio"
                },
                on: {
                    init: function() {
                        document.querySelector("[data-tokio-count]").innerHTML = +this.slides.length;
                    }
                }
            });
            if (document.querySelector(".slider-bergen__slider")) new core(".slider-bergen__slider", {
                modules: [ Navigation, EffectFlip ],
                effect: "flip",
                flipEffect: {
                    slideShadows: false
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-controls__button-prev.bergen",
                    nextEl: ".slider-controls__button-next.bergen"
                },
                on: {
                    init: function() {
                        document.querySelector("[data-bergen-count]").innerHTML = +this.slides.length;
                    }
                }
            });
            if (document.querySelector(".slider-york__slider")) new core(".slider-york__slider", {
                modules: [ Navigation, EffectFlip ],
                effect: "flip",
                flipEffect: {
                    slideShadows: false
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-controls__button-prev.york",
                    nextEl: ".slider-controls__button-next.york"
                },
                on: {
                    init: function() {
                        document.querySelector("[data-york-count]").innerHTML = +this.slides.length;
                    },
                    slideChange: function() {}
                }
            });
            if (document.querySelector(".item-choose126__slider")) new core(".item-choose126__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".controls-choose126__btn-prev",
                    nextEl: ".controls-choose126__btn-next"
                }
            });
            if (document.querySelector(".item-choose135__slider")) new core(".item-choose135__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".controls-choose135__btn-prev",
                    nextEl: ".controls-choose135__btn-next"
                }
            });
            if (document.querySelector(".item-choose120__slider")) new core(".item-choose120__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".controls-choose120__btn-prev",
                    nextEl: ".controls-choose120__btn-next"
                }
            });
            if (document.querySelector(".item-choose131__slider")) new core(".item-choose131__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".controls-choose131__btn-prev",
                    nextEl: ".controls-choose131__btn-next"
                }
            });
        }
...
***************************************************************************** */
        ...
        const script_elements = document.querySelectorAll(".element__item");
        ...
        let script_area = document.querySelector(".description__area-num > span");
        let logo = document.querySelector(".description__round");
        let areaVillage = document.querySelector(".description__area-village-num > span");
        function showDesc(element) {
            title.innerHTML = element.innerHTML;
            logo.innerHTML = element.innerHTML;
            script_area.innerHTML = element.dataset.area + " ";
            areaVillage.innerHTML = element.dataset.village + " ";
            void 0 !== element.dataset.price ? price.innerHTML = element.dataset.price : price.innerHTML = "по запросу";
            let descriptionHeight = description.clientHeight;
            description.style.top = element.offsetTop + 40 + descriptionHeight > 750 ? element.offsetTop - descriptionHeight + "px" : element.offsetTop + 40 + "px";
        ...
        function openDesc() {
            if (!isMobile.any()) script_elements.forEach((element => {
            ...
            })); else parentElements.addEventListener("click", (e => {
        ...
        buttons.addEventListener("click", (e => {
            ...
            if (e.target.classList.contains("zoom-minus")) {
                ...
                let zoomArr = wrap.style.zoom.split("%");
                if (100 != zoomArr[0]) wrap.style.zoom = +zoomArr[0] - 20 + "%"; else {
        ...
        initDelay(".box-advantages__item", .1);
        initDelay(".village-gallery__photo > img", .15);
        initDelay(".white-box__image > img", .15);
        isWebp();
        addTouchClass();
        addLoadedClass();
        formFieldsInit({
